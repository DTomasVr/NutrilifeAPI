...
public class SpecialistProfileService {
    ...
    public SpecialistProfileResponseDTO createProfileSpecialist(SpecialistProfileRequestDTO specialistProfileRequestDTO) {
        ...
        specialistProfile.setOcupation(specialistProfileRequestDTO.getOcupation().toUpperCase());
    ...
    @Transactional
    public List<SpecialistProfileResponseDTO> getSpecialistProfilesByOccupation(String ocupation) {
        List<SpecialistProfile> specialistProfiles = specialistProfileRepository.findByOcupation(ocupation);
        if (specialistProfiles.isEmpty()) {
            throw new UserNotFound("Especialista no encontrado con la ocupación: " + ocupation);
        }
        return specialistProfileMapper.convertToListDTO(specialistProfiles);
    }
